classdef fitting_app_multitab_beta_2_exported < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function PlotselectedfilesButtonPushed(app, event)
            ...
            for i=1:length(items_list)
                ...
                labs=[];
                for i=log10(zeroMark*10):ceil(max(M.allTestData_testConc_logplus2+2))+app.OrderofmagnitudeadjustmentEditField.Value
                    labs=[labs,(1:9)*10^i];
                end
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.xminEditField_2Label.Position = [508 170 31 22];
            ...
            app.xminEditField_2.Editable = 'off';
            app.xminEditField_2.Enable = 'off';
            app.xminEditField_2.Position = [554 170 77 22];
            ...
            app.xmaxEditFieldLabel.Position = [505 140 34 22];
            ...
            app.xmaxEditField.Editable = 'off';
            app.xmaxEditField.Enable = 'off';
            app.xmaxEditField.Position = [554 140 77 22];
            ...
            app.yminEditFieldLabel.Position = [508 111 31 22];
            ...
            app.yminEditField.Editable = 'off';
            app.yminEditField.Enable = 'off';
            app.yminEditField.Position = [554 111 77 22];
            ...
            app.ymaxEditField_3Label.Position = [505 81 34 22];
            ...
            app.ymaxEditField_3.Editable = 'off';
            app.ymaxEditField_3.Enable = 'off';
            app.ymaxEditField_3.Position = [554 81 77 22];
            ...
            app.ColoursListBox.Position = [554 203 75 74];
    ...
    methods (Access = public)
        ...
        % Construct app
        function app = fitting_app_multitab_beta_2_exported
